...
class OnnxModel(DocLayoutModel):
    ...
    @staticmethod
    def from_pretrained():
        # Use local model path - update this path to where you've placed your model
        model_path = "/Users/likhithbhargav/Desktop/PDFMathTranslate-main 4/doclayout_yolo_docstructbench_imgsz1024.onnx"
        # if not os.path.exists(model_path):
            # Fallback to common model names if the default path doesn't exist
            # for possible_name in ["doclayout_yolo_docstructbench_imgsz1024.onnx", "model.onnx"]:
            #     if os.path.exists(possible_name):
            #         model_path = possible_name
            #         break
            # else:
                # raise FileNotFoundError(
                #     f"Model file not found. Please place your ONNX model file at: {model_path} "
                #     "or update the model_path variable in this method."
                # )
