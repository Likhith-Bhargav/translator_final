...
# ============================================================================
# Flask Application - Dataiku will detect this 'app' object
# ============================================================================
...
class NLLBDirect:
    ...
    def __init__(self, model_path: Optional[str] = None):
        if model_path is None:
            # Use environment variable or config, fallback to relative path
            default_model = ConfigManager.get(
                "NLLB_MODEL_PATH",
                os.path.join(os.getcwd(), "models", "facebook_nllb-200-distilled-600M")
            )
            self.model_path = Path(default_model)
        else:
...
class OnnxModel:
    ...
    def from_pretrained():
        # Use environment variable or config, fallback to relative path
        model_path = ConfigManager.get(
            "ONNX_MODEL_PATH",
            os.path.join(os.getcwd(), "doclayout_yolo_docstructbench_imgsz1024.onnx")
        )
    ...
    def resize_and_pad_image(self, image, new_shape):
        ...
        # Replace cv2.resize with PIL Image.resize
        ...
        # Replace cv2.copyMakeBorder with numpy padding
        image = np.pad(
            image,
...
def get_font_path(lang: str) -> str:
    ...
    lang = lang.lower()
    # Use environment variable or config, fallback to relative path
    default_assets = ConfigManager.get(
        "ASSETS_DIR",
        os.path.join(os.getcwd(), "BabelDOC-Assets-main")
    )
...
# ============================================================================
# Flask Web Application Routes for Dataiku Integration
# ============================================================================
...
if __name__ == "__main__":
    ...
    logger.info("Starting PDF Translator Flask application...")
